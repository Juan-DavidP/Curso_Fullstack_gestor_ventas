...
// Falta implementacion de lógica metodos para guardar, eliminar y lógica de selects
...
<div class="container-fluid">
    ...
    <div class="row">
        <div class="col-12 mb-3">
            ...
            <button type="submit" class="btn btn-danger" id="btnEliminar" name="btnEliminar">Borrar</button>
        </div>
    </div>
    <div class="row">
        ...
        <div class="col-6 form-group">
            ...
            <input type="text" required class="form-control" name="txtNit" id="txtNit" value="<?php echo $cliente->nit ?>" maxlength="11">
        </div>
        <div class="col-6 form-group">
        ...
        $.ajax({
            ...
            success: function(respuesta) {
                ...
                respuesta.forEach(function(valor, indice) {
                    resultado += `<option value="${valor.id_localidad}">${valor.nombre}</option>`;
                });
